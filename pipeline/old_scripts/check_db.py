...
print(status.value_counts())
    # status = [well.seq_outcome for well in part.wells if well.plates.plate_type == 'seq_plate']
    # print(part.part_id,status)
    ...
    #     try:
    #         if well.plates.plate_type == 'seq_plate':
    #             print(part.part_id,well.address,well.seq_outcome)
    #     except:
    #         continue
